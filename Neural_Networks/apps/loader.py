...
class RobotDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 stride: int = 1,
                 normalise: bool = True):
        assert mode in ("pointwise", "sequence"), f"mode must be 'pointwise' or 'sequence'"
    ...
    def _build_physics(self, idx):
        ...
        that sums normalised components (EC-PINN residual, Decomposed warm start,
        PhysicsRegularized soft target, nominal consistency anchors).
        """

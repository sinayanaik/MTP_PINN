...
| Residual-Corr | 0.08165 | 0.92362 | 0.04533 | `ResidualCorrectionFNN_ep455_rmse0.08367_frac0.1_lr3e-4_wd0.01_do0.1_bs1024_hl256` |
...
- **Black-Box** (BlackBoxFNN): RMSE in [0.08303, 0.15778] N·m over 42 run(s); R2 in [0.76716, 0.92102].
- **Physics-Reg** (PhysicsRegularizedFNN): RMSE in [0.07928, 0.15439] N·m over 302 run(s); R2 in [0.77706, 0.92799].
- **Residual-Corr** (ResidualCorrectionFNN): RMSE in [0.08153, 0.12117] N·m over 194 run(s); R2 in [0.86268, 0.92384].

...
- **Black-Box** (BlackBoxFNN): RMSE in [0.08303, 0.08771] N·m over 8 run(s); R2 in [0.91187, 0.92102].
- **Physics-Reg** (PhysicsRegularizedFNN): RMSE in [0.07928, 0.10849] N·m over 40 run(s); R2 in [0.86515, 0.92799].
- **Residual-Corr** (ResidualCorrectionFNN): RMSE in [0.08153, 0.08518] N·m over 24 run(s); R2 in [0.91688, 0.92384].

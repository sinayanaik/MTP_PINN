#!/usr/bin/env python3
"""Residual torque correction training (τ_phys + Δ).

From repository root::

    PYTHONPATH=. python3 -m Neural_Networks.models.run_physics_residual
"""
...
from Neural_Networks.models.shared.strategies import RESIDUAL_STRATEGY
...
MODELS_DIR = str(_NN_ROOT / "Trained_Models" / "Journal_Comparison" / "ResidualCorrection")
...
MODEL_TYPE = "ResidualCorrectionFNN"
SAVE_SUBDIR = "ResidualCorrectionFNN"
...
def main() -> None:
    job = TrainJob(
        ...
        run_help="Neural_Networks/models/run_physics_residual.py",
    )
    main_cli(job, log_name="run_physics_residual")
